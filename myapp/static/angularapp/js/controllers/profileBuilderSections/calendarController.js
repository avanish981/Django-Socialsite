...
mySocialElite.factory('alert', function($uibModal, $rootScope, $http) {
      ...
      controller: function() {
        ...
        vm.deleteExistingEvent = function() {
          ...
          $http({
            url: '/calender',
            method: 'DELETE',
            data: {'eventDetails':vm.eventDetails,'emailId':false},
        ...
        vm.saveExistingEvent = function() {
          ...
          $http({
            url: '/calender',
            method: 'PUT',
            data: {'eventDetails':vm.eventDetails,'emailId':false,'timeOffsetStart':vm.eventDetails.startsAt.getTimezoneOffset(),'timeOffsetEnd':vm.eventDetails.endsAt.getTimezoneOffset()},
          }).success(function(response) {
              //console.log(response);
...
mySocialElite.controller('calendarController', function($scope, moment, alert, calendarBlock,$http) {
    ...
    vm.saveNewEvent =function(){
      ...
      $http({
        url: '/calender',
        method: 'POST',
        data: {'eventDetails':vm.calNewEvent,'emailId':false,'timeOffsetStart':vm.calNewEvent.startsAt.getTimezoneOffset(),'timeOffsetEnd':vm.calNewEvent.endsAt.getTimezoneOffset()},
      }).success(function(response) {
          //console.log(response);
          vm.resetNewEvent();
          $scope.getCalendarExtent();
    ...
    $scope.$on('openEvenEditor', function(event, data) {
